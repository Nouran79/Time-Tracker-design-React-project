import "./App.css"
import vary from './images/imagejeremy.jpg'
function App(){
    return(
        <html>
<body>
          <div className="cards">
            ...
            <div id="firstOneLeft">
                <div id="p1">
                    <div> <img src={vary} alt="boy" id="boy"/></div>
                   <div id="boyData"> <p id="l1">Report for</p>
                    <p id="l2">Jeremy Robson</p></div>
                </div>
                <div id="p2">
                    <p>Daily</p>
                    <p> Weekly</p>
